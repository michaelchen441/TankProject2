...
public class PlayerTank extends Tank
{
	...
	// The input move array is filled with certain x and y loc changes based on
	// user input
	// Based off of these movements, one can detect which direction the movement
	// will occur in
	...
	// Establishes the movements that need to be made into the inputMoveArr
	// instance variable for the Playertank object
